...
import 'package:flutter_app_erp/core/http/products_prices/delete_products_prices.dart';
...
Widget ButtonDeleteProductPrice({
...
class AlertDialogDelete extends StatefulWidget {
  ...
  const AlertDialogDelete(
      {super.key, required this.productPriceId, this.onAfterDelete});
...
// este funcion espera una respuest
  Future<void> onDeleteRequest(BuildContext context) async {
    ...
    try {
      await deleteProductPrice(id: widget.productPriceId, token: token ?? '');
