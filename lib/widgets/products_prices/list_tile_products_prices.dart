...
class ListTileContentProductsPrices extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return SizedBox(
      ...
      child: SliceColumn(
        children: [
          ColumnCell(subtitle: "Moneda: ", content: productPrice.currency!.code),
          ColumnCell(subtitle: "Producto: ", content: productPrice.product!.name),
...
class ListTileProductPrice extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return ListTileApp(
      ...
      title: TypographyApp(text: "${productPrice.product!.name}",),
      heightContent: 100,
...
class ListTileProductsPrices extends StatelessWidget {
  ...
  Widget buildItem(BuildContext context, ProductsPricesResponse productPrice) {
    return Column(
      children: [
        ListTileProductPrice(productPrice: productPrice, onAfterChange: onAfterChange),
  ...
  Widget build(BuildContext context) {
    return ListViewApp(
      ...
      buildItems: (context, ta) => buildItem(context,),
    );
  }
}